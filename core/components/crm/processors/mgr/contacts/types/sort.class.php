...
class crmTypesSortProcessor extends modObjectProcessor
{
    ...
    public function process()
    {
        ...
        foreach ($sources as $id) {
            /** @var crmContactType $source */
            $source = $this->modx->getObject($this->classKey, $id);
            /** @var crmContactType $target */
     ...
     * @return array|string
     */
    public function sort(crmContactType $source, crmContactType $target)
    {
